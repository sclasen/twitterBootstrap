...
pre.    		   GET 	    /twitter    	module:twitter_bootstrap
...
You can edit any of the .less files in modules/twitter_bootstrap-1.2.0/public and the less plugin will automatically recompile the css.
